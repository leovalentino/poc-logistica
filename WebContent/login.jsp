...
<div class = "col-sm-4  col-md-offset-4" ng-app="GerenciarFrete.module">
	<h1>SISLOGIS</h1>
	
	<div ng-controller = "crudtarifa">
		<div class="form-group" ng-submit="pesquisartarifas()">
			<form>
				...
				Senha:<input class="form-control" type="number" ng-model="valorTarifa" placeholder="Senha"/>
			</form>
			<div align="rigth">
				<button ng-click="pesquisartarifas()" class="btn btn-primary">Logar</button>
